...
def train_hf_model(
    ...
    """
    Trains/Fine-tunes a Hugging Face BertForSequenceClassification or DistilBertForSequenceClassification 
    model (PyTorch backend).

    This function expects pre-tokenized Hugging Face Dataset objects for training
    and evaluation, loads the model, and trains it using the Hugging Face Trainer API.
